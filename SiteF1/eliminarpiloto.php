      ...
      <div class="min-h-full">
         ...
         <header class="bg-white shadow">
            <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
               <h1 class="text-3xl font-bold text-gray-900">Eliminar - Piloto</h1>
            </div>
         </header>
         <main>
            <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8" align="center">
               ...
               <?php
                    ...
                    while ($row = $resultado->fetch_assoc()){
                        ...
                        //echo "<td>" . '<a href="actionpiloto.php?CodPiloto=' . $row['CodPiloto'] . '$operacao=eliminar">  Eliminar </a>';
                        echo "<td>" . '<a class="bg-red-600 hover:bg-red-800 text-white font-bold py-2 px-4 rounded" href="include/deletepiloto.php?id='. $row['CodPiloto'] .'">  Eliminar </a>';
                        echo "</tr>";
                        }
                        echo "</table>";
                    }

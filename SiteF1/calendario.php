         ...
         <main>
            <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8" align="center">
               ...
               <?php
                  ...
                  $consulta = 'SELECT nome, pais, numvoltas, datacorrida,  logo FROM calendario';
                  ...
                  echo "<td>" . $row['nome'] . "</td>";
                  echo "<td>" . $row['pais'] . "</td>";
                  echo "<td>" . $row['numvoltas'] . "</td>";
                  echo "<td>" . $row['datacorrida'] . "</td>";
                  echo "<td><img src='img/pistas/{$row["logo"]}'></td>";
                  echo "</tr>";
                  }
                  echo "</table>";

      ...
      <div class="min-h-full">
         ...
         <header class="bg-white shadow">
            <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
               <h1 class="text-3xl font-bold text-gray-900">Eliminar - Equipa</h1>
            </div>
         </header>
         <main>
            <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8" align="center">
               ...
               <div class="mx-auto flex flex-col sm:flex-row items-start sm:items-center justify-center p-6">
                ...
                <div class="flex items-start">
                    <div role="tablist" aria-label="filter content by" class="border flex bg-white text-gray-500 shadow rounded">
                        <button type="submit" name="button1" class="py-3 px-5 flex items-center justify-center text-xs focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 rounded " onclick="window.location.href='http://localhost/sitef1/eliminarpiloto.php';">Pilotos</button>    
                    </div>
                </div>
                <!-- Code block ends -->
                <!-- Code block starts -->
                <div class="flex items-start mt-4 sm:mt-0 sm:ml-4">
                    <div role="tablist" aria-label="filter content by" class="border flex bg-white text-gray-500 shadow rounded">
                        <button type="submit" name="button" class="py-3 px-5 flex items-center justify-center text-xs focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-300 focus:ring-gray-800 rounded" onclick="window.location.href='http://localhost/sitef1/eliminarequipa.php';">Equipas</button>
                    </div>
                </div>
                </div>
               ...
               <?php
                    ...
                    while ($row = $resultado->fetch_assoc()){
                        ...
                        echo "<tr>";
                        echo "<td>" . $row['nome'] . "</td>";
                        echo "<td><img src='img/equipas/{$row["logo"]}'></td>";
                        echo "<td>" . $row['nomecompleto'] . "</td>";
                        echo "<td>" . $row['base'] . "</td>";
                        echo "<td>" . $row['chef'] . "</td>";
                        echo "<td>" . $row['anofunda'] . "</td>";
                        echo "<td>" . $row['campeonatos'] . "</td>";
                        echo "<td>" . '<a class="bg-red-600 hover:bg-red-800 text-white font-bold py-2 px-4 rounded" href="include/deleteequipa.php?id='. $row['Codequipa'] .'">  Eliminar </a>';

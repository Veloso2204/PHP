      ...
      <div class="min-h-full">
         ...
         <header class="bg-white shadow">
            <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
               <h1 class="text-3xl font-bold text-gray-900">Standings - Equipa</h1>
            </div>
         </header>
         <main>
               ...
               <div class="mx-auto flex flex-col sm:flex-row items-start sm:items-center justify-center p-6">
                ...
                <div class="flex items-start">
                    <div role="tablist" aria-label="filter content by" class="border flex text-gray-500 shadow rounded">
                        <buttonn type="button" class="py-3 px-5 flex items-center justify-center text-xs focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-300 focus:ring-gray-800 rounded" onclick="window.location.href='http://localhost/sitef1/stanpiloto.php';">Pilotos</buttonn>
                ...
                <?php
                  ...
                  $consulta = 'SELECT equipa_ponto.ponto, equipa.nome FROM equipa_ponto inner Join equipa on equipa.CodEquipa = equipa_ponto.CodEquipa Order By equipa_ponto.ponto Desc';
